...
ASANA_CUSTOM_FIELD_TEAM_ENUM_VALUES = {
    ...
    Teams.DEV_EXP: "1201625293756972",
    Teams.DATA: "1200210900372025",
    Teams.SERVICES: "1201625293756971",
    ...
    Teams.ADOPTION: "1201623696888812",
    Teams.SELF_SERVE: "1200210900372048",
}

ASANA_TRIBES_TEAMS_MAPPING = {
    Tribes.PLATFORM: [Teams.CORE, Teams.DEV_EXP, Teams.DATA, Teams.SERVICES, Teams.SRE],
    Tribes.APPS: [Teams.APPS_ECOMMERCE, Teams.APPS_CHANNELS, Teams.APPS_DEVELOPER_RELATIONS],
    Tribes.AUTOMATIONS: [Teams.ADOPTION, Teams.AUTOMATIONS, Teams.SELF_SERVE],
}
